...
class MajoritiesPlayer(Player, ABC):
    ...
    def print_stats(self):
        num_wins = self.__stats[MajoritiesResult.WIN]
        print(
    ...
    def event_result(self, pos: int, result: MajoritiesResult):
